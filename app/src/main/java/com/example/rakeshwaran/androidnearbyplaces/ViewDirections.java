...
import com.example.rakeshwaran.androidnearbyplaces.Helper.DirectionJSONParser;
...
public class ViewDirections extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void drawPath(Location mLastLocation, com.example.rakeshwaran.androidnearbyplaces.Model.Location location) {
        // Clear all polyline
