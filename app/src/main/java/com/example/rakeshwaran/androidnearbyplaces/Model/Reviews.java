...
public class Reviews {
    ...
    {
        return "Class [time = "+time+", text = "+text+", profile_photo_url = "+profile_photo_url+", relative_time_description = "+relative_time_description+", author_url = "+author_url+", author_name = "+author_name+", rating = "+rating+", language = "+language+"]";
    }
}
